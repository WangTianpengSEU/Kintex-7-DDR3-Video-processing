...
HD_PWD='H:/Desktop/PCB_test_DDR3_30fps_1/PCB_test_DDR3_ok1/PCB_test/PCB_test.runs/Video_in_distribute_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Video_in_distribute_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Video_in_distribute_ram.tcl
