...
HD_PWD='H:/Desktop/PCB_test_30fps_3_no_noise_copy/PCB_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PCB_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PCB_test.tcl
