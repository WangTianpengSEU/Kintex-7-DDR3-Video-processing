...
HD_PWD='H:/Desktop/Code_copy/PCB_test_60fps_1/PCB_test.runs/Video_in_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Video_in_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Video_in_ram.tcl
